...
under test are within an element with particular CSS style
...
4. Depending on a test framework delegated methods in `Pages::Base` will differ, but it can be used other test frameworks (like RSpec) too
